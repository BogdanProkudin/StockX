...
const Validation: React.FC = () => {
  const [isValue, setIsValue] = React.useState("registr");
...
"
      ...
      <div className={styles.flex}>
        <div className={styles.validBlock}>
          <div>
            <button
              onClick={() => setIsValue("registr")}
              className={`${styles.validBtns} ${
                isValue === "registr" ? styles.active : ""
              }`}
            >
              Sign Up
            </button>
            <button
              onClick={() => setIsValue("login")}
              className={`${styles.validBtns} ${
                isValue === "login" ? styles.active : ""
              }`}
            >
              Log in
            </button>
          </div>
          {isValue == "registr" && <Registration />}
          {isValue == "login" && <Login />}
        </div>
      </div>
    </div>
