...
const HeaderUser = () => {
  ...
  const profileArr: { img: string; name: string }[] = [
    { img: "icon_profile.png", name: "Profile" },
    { img: "icon_buying.png", name: "Buying" },
    { img: "icon_selling.png", name: "Selling" },
    { img: "icon_favorites.png", name: "Favorites" },
    { img: "icon_portfolio.png", name: "Portfolio" },
    { img: "icon_wallet.png", name: "Wallet" },
    { img: "icon_settings.png", name: "Settings" },
    { img: "icon_logout.png", name: "Log Out" },
  ];
  return (
